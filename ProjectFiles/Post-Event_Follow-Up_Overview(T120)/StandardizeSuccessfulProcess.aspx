<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StandardizeSuccessfulProcess.aspx.cs" Inherits="StandardizeSuccessfulProcess" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 <link rel="stylesheet" href="StyleSheets/StandardizeSuccessfulProcess_Layout.less" type="text/css"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-card">
            <h1>Standardize Successful Process</h1>
